...
<head>
    ...
    <style>
        ...
        button {
            display: block;
            background-color: #38f787;
            padding: 10px 20px;
            color: white;
            font-family:'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif;
            border: 2px solid #22c846;
            font-weight: bold;
        }
        .button-submit{
            margin: 40px 50px;
...
<body>
    <div class="form-contenedor">
        <h2 class="form-titulo">Registrar Tecnico In Situ</h2>
        <form action="{{ url('/api/register') }}" method="POST">
            @csrf
            <div class="campos-group">
                <input type="hidden" name="rol" value="InSituSupport">
